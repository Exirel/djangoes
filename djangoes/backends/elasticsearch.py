...
class ConnectionWrapper(Base):
    ...
    def create(self, doc_type, body, id=None, **kwargs):
        return self._es.create(self.indices, doc_type, body, id, **kwargs)

    def index(self, doc_type, body, id=None, **kwargs):
        return self._es.index(self.indices, doc_type, body, id, **kwargs)

    def exists(self, id, doc_type='_all', **kwargs):
        return self._es.exists(self.indices, id, doc_type, **kwargs)

    def get(self, id, doc_type='_all', **kwargs):
        return self._es.get(self.indices, id, doc_type, **kwargs)

    def get_source(self, id, doc_type='_all', **kwargs):
        return self._es.get_source(self.indices, id, doc_type, **kwargs)

    def update(self, doc_type, id, body=None, **kwargs):
        return self._es.update(self.indices, doc_type, id, body, **kwargs)
    ...
    def explain(self, doc_type, id, body=None, **kwargs):
        return self._es.explain(self.indice, doc_type, id, body, **kwargs)

    def delete(self, doc_type, id, **kwargs):
        return self._es.delete(self.indices, doc_type, id, **kwargs)
    ...
    def percolate(self, doc_type, id=None, body=None, **kwargs):
        return self._es.percolate(self.indices, doc_type, id, body, **kwargs)

    def count_percolate(self, doc_type, id=None, body=None, **kwargs):
        return self._es.count_percolate(self.indices, doc_type, id, body, **kwargs)

    def mlt(self, doc_type, id, body=None, **kwargs):
        return self._es.mlt(self.indices, doc_type, id, body, **kwargs)

    def termvector(self, doc_type, id, body=None, **kwargs):
        return self._es.termvector(self.indices, doc_type, id, body, **kwargs)
